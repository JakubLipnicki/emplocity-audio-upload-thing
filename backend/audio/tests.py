...
from django.core.exceptions import ValidationError  # Do testowania walidatorów
from unittest.mock import patch, MagicMock  # MagicMock do symulowania obiektu instance
import os
import json
import uuid
import time
...
from .models import AudioFile, Tag, Like, validate_audio_file_extension, audio_file_upload_to, \
    set_s3_content_disposition_metadata

# Zaimportujmy też ALLOWED_AUDIO_EXTENSIONS, jeśli value_object jest dostępne
try:
...
def create_dummy_file(filename="dummy_test_file.mp3", content=b"dummy content", content_type='audio/mpeg'):
...
# === KLASY TESTOWE DLA TAGÓW, Z POPRZEDNIEJ ODPOWIEDZI ===
